...
<h1>Venues</h1>
	...
	<table>
		...
		<td><div><input style="width: 300px" type="text" name="enterFilter" placeholder="Enter Venue IDs (separated by ',') or 'all'" /></div></td>
		<td><div><button style="width: 150px" type="submit" name="submitForm" value="updateAuthOnVenue">Update Authorisations</button></div></td>
		</form>
		<form action="<?php echo site_url('main/delete_duplicates')?>" method="post">
		<td style="width: 100%"><div><button style="float:right; width: 150px" type="submit" name="submitForm" value="deleteDuplicatesOnVenue">Delete Duplicates</button></div></td>
		</form>
		</tr>
	</table>
	</div>
