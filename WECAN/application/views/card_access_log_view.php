...
<h1>Card Access Logs</h1>
	...
	<table>
		...
		<td style="width: 100%"><div><button style="float:right; width: 150px" type="submit" name="submitForm" value="deleteDuplicatesOnAccess">Delete Duplicates</button></div></td>
		</form>
		</tr>
		<tr>
	</table>
