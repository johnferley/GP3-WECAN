...
<h1>Fixtures</h1>
	...
	<table>
		...
		<td><div style="width: 300px"><input type="text" name="enterFilter" placeholder="Enter Fixture IDs (separated by ',') or 'all'" /></div></td>
		<td><div style="width: 150px"><button type="submit" name="submitForm" value="updateAuthOnFixture">Update Authorisations</button></div></td>
		</form>
		</tr>
	</table>
	</div>
